...
def test_format_reading_data(source_data):
    ...
    expected_data = pd.DataFrame(
        data=[
            ['1970-05-01', '64640', reference_altitude - 0.1, nan, nan, 0],
            ['2005-11-01', '64640', reference_altitude - 1.1, -1.1, 3.16, 1],
            ['2005-11-03', '64640', reference_altitude - 4.1, -4.2, 7.16, 3],
            ['2005-11-04', '64640', reference_altitude - 5.1, -5.1, 3.16, 4]],
        columns=[
